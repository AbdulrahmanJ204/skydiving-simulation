...
<!-- Skydiver Properties -->
<div>
  <h3 style="color: #81C784; border-bottom: 1px solid #555; padding-bottom: 5px; padding-top: 5px;">Skydiver Properties
  </h3>
  <div style="display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 40px; margin-right: 15px">
    <div>
      <label>Mass (kg):</label>
  ...
  <h4 style="color: #A5D6A7; margin-top: 25px;">Start Position</h4>
  <div style="display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 40px; margin-right: 15px">
    <div>
    ...
    <div>
      ...
      <input type="number" id="startY" value="${this.initialValues.startPosition.y}" min="100" max="10000" step="50">
    </div>
    <div>
...
<div style="display: grid; grid-template-columns: 1fr 1fr; gap: 40px; margin-right: 15px">
  ...
  <div>
    ...
    <input type="number" id="gravity" value="${this.initialValues.gravity}" min="-20" max="20" step="0.1">
  </div>
  ...
  <div>
    ...
    <input type="number" id="dragCoeffBefore" value="${this.initialValues.dragCoefficientBeforeParachute}" min="0.001"
      max="0.2" step="0.001">
  </div>
  ...
  <div>
    ...
    <input type="number" id="liftCoeffBefore" value="${this.initialValues.liftCoefficientBeforeParachute}" min="0.001"
      max="0.15" step="0.01">
  </div>
...
<div>
  ...
  <input type="number" id="parachuteHeight" value="${this.initialValues.parachuteOpenHeight}" min="100" max="3000"
    step="50">
